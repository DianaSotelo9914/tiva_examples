 ...
 * cada vez que se pulsa un botan, sube o baja la intensidad luminosa
...
int main(void)
{
    ...
    //Configurar el pwm0, contador descendente y sin sincronizacian (actualizacian automatica)
